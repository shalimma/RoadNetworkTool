...
void URoadNetworkToolLineTool::Setup()
{
	...
	Properties = NewObject<URoadNetworkToolLineToolProperties>(this, "Measurement");
...
void URoadNetworkToolLineTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
void URoadNetworkToolLineTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
...
void URoadNetworkToolLineTool::UpdatePosition(const FRay& WorldRay)
{
...
void URoadNetworkToolLineTool::UpdateDistance()
{
...
void URoadNetworkToolLineTool::Render(IToolsContextRenderAPI* RenderAPI)
{
