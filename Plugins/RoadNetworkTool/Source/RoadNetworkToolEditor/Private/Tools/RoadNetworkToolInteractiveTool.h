 ...
 */
UCLASS()
class ROADNETWORKTOOL_API URoadNetworkToolInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
 ...
 */
UCLASS(Transient)
class ROADNETWORKTOOL_API URoadNetworkToolInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class ROADNETWORKTOOL_API URoadNetworkToolInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
