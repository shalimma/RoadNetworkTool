...
#include "RoadProjectOffroadCar.h"
#include "RoadProjectOffroadWheelFront.h"
#include "RoadProjectOffroadWheelRear.h"
...
ARoadProjectOffroadCar::ARoadProjectOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = URoadProjectOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = URoadProjectOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = URoadProjectOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = URoadProjectOffroadWheelRear::StaticClass();
