...
#include "RoadProjectSportsCar.h"
#include "RoadProjectSportsWheelFront.h"
#include "RoadProjectSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ARoadProjectSportsCar::ARoadProjectSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = URoadProjectSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = URoadProjectSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = URoadProjectSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = URoadProjectSportsWheelRear::StaticClass();
